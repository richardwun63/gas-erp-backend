    ...
    try {
        ...
        users.forEach(emp => {
            ...
            row.innerHTML = `
                ...
                <td>${statusTagHTML}</td>
                <td>
                    <button class="btn btn-secondary btn-sm" title="Editar Datos" onclick="openEditUserModal(${emp.user_id})">
                        <i class="fas fa-edit"></i>
                    </button>
                    ${emp.role_name === 'repartidor' ? `<button class="btn btn-info btn-sm" title="Editar Horario" onclick="openEditScheduleModal(${emp.user_id})">
                    ...
                    <button class="btn btn-danger btn-sm" title="Eliminar Empleado" onclick="deleteEmployee(${emp.user_id})">
