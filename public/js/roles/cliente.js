// ==================================
// js/roles/cliente.js
// Lógica específica para el dashboard del Cliente (v8 - Errores corregidos)
// ==================================
console.log('[cliente.js] Módulo cargado. v8');
...
async function populateClienteOrderOptions() {
    console.log("[cliente/populateOrderOptions v8] Poblando opciones...");
    ...
    try {
        ...
        if (tipoBalonSelect) {
            ...
            console.log("[cliente/populateOrderOptions v8] Selector de balón poblado.");
        }
        ...
        if (otrosProductosDiv) {
            ...
            if (!otherProducts.some(p => p.is_available)) {
                ...
                console.log("[cliente/populateOrderOptions v8] Otros productos poblados.");
            }
        }

        // Actualizar precio estimado inicial
        updatePedidoPriceEstimate();
        console.log("[cliente/populateOrderOptions v8] Opciones cargadas OK.");

    } catch (error) {
        console.error("[cliente/populateOrderOptions v8] Error:", error);
...
async function loadClienteHistorial() {
    console.log("[cliente/loadHistorial v8] Cargando historial...");
    ...
    try {
        ...
        console.log("[cliente/loadHistorial v8] Iniciando petición a /orders/my-history");
        ...
        console.log(`[cliente/loadHistorial v8] ${history.length} pedidos recibidos.`);
        ...
        console.log("[cliente/loadHistorial v8] Historial cargado OK.");
        
    } catch (error) {
        console.error("[cliente/loadHistorial v8] Error:", error);
...
async function loadClienteProfileData() {
    console.log("[cliente/loadProfileData v8] Cargando datos perfil...");
    
    try {
        // Obtener datos del perfil
        console.log("[cliente/loadProfileData v8] Fetching /users/me...");
        const response = await fetchWithAuth('/users/me');
        ...
        const userData = await response.json();
        console.log("[cliente/loadProfileData v8] Datos recibidos:", userData);
        ...
        console.log("[cliente/loadProfileData v8] Datos de perfil cargados OK.");
        
    } catch (error) {
        console.error("[cliente/loadProfileData v8] Error:", error);
...
export async function setupClienteDashboard() {
    console.log('[cliente.js v8] Configurando Dashboard Cliente...');
    ...
    try {
        ...
        console.log('[cliente/setup v8] Contenedor del dashboard encontrado:', dashboardElement);
        ...
        results.forEach((result, index) => {
            if (result.status === 'rejected') {
                ...
                console.error(`[cliente/setup v8] Error al cargar ${modules[index]}:`, result.reason);
            }
        });
        ...
        if (pedidoForm) {
            ...
            console.log('[cliente/setup v8] Listeners formulario de pedido OK.');
        } else {
            console.error("[cliente/setup v8] Formulario #pedido-form no encontrado.");
        }
        ...
        if (fileInput) {
            ...
            console.log('[cliente/setup v8] Listener input de archivo OK.');
        } else {
            console.warn("[cliente/setup v8] Input #payment-proof-input no encontrado.");
        }
        ...
        console.log('[cliente.js v8] Dashboard Cliente configurado OK.');

    } catch (error) {
        console.error('[cliente.js v8] Error FATAL durante setup:', error);
