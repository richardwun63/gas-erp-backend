...
async function logSuccessfulLogin(connection, userId, ipAddress) {
    try {
        // Intentamos insertar en la tabla, pero manejamos silenciosamente errores si la tabla no existe
        await connection.execute(
        ...
        // Simplemente registramos el error pero no lo propagamos al flujo principal
        console.log('Nota: No se pudo registrar el login en SecurityLogs (tabla posiblemente no existente)');
        // No propagar el error para evitar afectar el flujo de autenticación
    }
}
...
async function logPasswordChange(connection, userId, ipAddress) {
    try {
        ...
        console.log('Nota: No se pudo registrar el cambio de contraseña en SecurityLogs (tabla posiblemente no existente)');
    }
}
...
async function logPasswordResetRequest(connection, userId, ipAddress) {
    try {
        ...
        // Simplemente registramos el error pero no lo propagamos
        console.log('Nota: No se pudo registrar la solicitud de reset en SecurityLogs (tabla posiblemente no existente)');
    }
}
...
async function logPasswordReset(connection, userId, ipAddress) {
    try {
        ...
        // Simplemente registramos el error pero no lo propagamos
        console.log('Nota: No se pudo registrar el reset de contraseña en SecurityLogs (tabla posiblemente no existente)');
    }
}
