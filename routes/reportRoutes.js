 ...
 * @desc Exportar cualquier reporte a CSV
 * @access Private - Contabilidad, Gerente
 */
router.get('/export', 
    restrictTo('contabilidad', 'gerente'), 
    [
        query('reportType').notEmpty().withMessage('Tipo de reporte requerido')
            .isIn(['sales', 'reconciliation', 'morosos', 'stock', 'performance', 'points'])
